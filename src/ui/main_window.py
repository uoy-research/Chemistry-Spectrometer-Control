...
class DevPanel(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.limits_checkbox.setFont(QFont("", 10))
        ...
        control_layout.addWidget(self.limits_checkbox,
        ...
        self.speed_spinbox.setFont(QFont("", 10))
        ...
        self.accel_spinbox.setFont(QFont("", 10))
    ...
    def set_motor_accel(self):
        ...
        self.parent.logger.info(f"Set motor acceleration to {
                                accel} (not implemented)")
...
class MainWindow(QMainWindow):
    ...
    def update_motor_port(self, port: int):
        ...
        self.logger.info(f"Active motor workers after update: {
                         MotorWorker.get_active_count()}")
