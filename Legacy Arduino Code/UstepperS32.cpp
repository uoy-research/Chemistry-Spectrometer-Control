...
int UstepperS32::getPosition(void)
{
	int32_t position = this->driver.getPosition();
	return (int)position;
}

void UstepperS32::movePosition(int32_t setPosition)
{
	this->driver.setDeceleration((uint16_t)(this->maxDeceleration));
	this->driver.setAcceleration((uint16_t)(this->maxAcceleration));
	this->driver.setVelocity((uint32_t)(this->maxVelocity));
	...
	this->driver.setPosition(setPosition);
}

/* void UstepperS32::movesixmTPosition(int32_t sixmTPosition)
{
	this->driver.setDeceleration((uint16_t)(this->maxDeceleration));
	this->driver.setAcceleration((uint16_t)(this->maxAcceleration));
	this->driver.setVelocity((uint32_t)(this->maxVelocity));
	...
	// Set absolute position
	this->driver.setPosition(sixmTPosition);
}
*/
